...
class EditProfileActivity : AppCompatActivity() {
    ...
    fun onSaveClicked(view: View) {
      //myRef.setValue("yes")
        ...
        val myStudentProfile =  StudentDataClass(tutorName.text.toString(), tutorAge.text.toString(), tutorGender.text.toString(), tutorAddress.text.toString(), tutorPhone.text.toString(), tutorGrade.text.toString(), tutorCourse.text.toString(), tutorEmail.text.toString())
       Log.d("mytag", "databaseCheck")

        myRef.setValue(myStudentProfile)
        database.goOffline()
